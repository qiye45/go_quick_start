...
func jsonTest() {
	url := "https://www.googleapis.com/customsearch/v1/siterestrict?key=AIzaSyCIivhVfq-5L9yT8RQ9J8olrRV67lE_Ta8&cx=017576662512468239146:omuauf_lfve&q=golang"
...
func jsonDeserilizeTest2() {
	...
	//fmt.Println("C:", c["address"].(map[string]int)["cell"]) //panic: interface conversion: interface {} is map[string]interface {}, not map[string]int
